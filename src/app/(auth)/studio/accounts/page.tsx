                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <SolarIcon
                          icon={getProviderIcon(account.provider) as any}
                          className="h-4 w-4"
                        />
                  ...
                  <div className="flex items-center gap-2">
                    {!isCurrent && (
                      <Button
                        ...
                        className="flex-1"
                      >
                        <SolarIcon icon="swap-bold" className="h-4 w-4 mr-2" />
                        Activer ce compte
                      </Button>
                    )}
                    {!isCurrent && (
                      ...
                      >
                        <SolarIcon icon="trash-bin-minimalistic-bold" className="h-4 w-4 mr-2" />
                        Supprimer
                      </Button>
                    )}
                    {isCurrent && (
