...
function SavedContent() {
  ...
  // TODO: Implémenter getSavedDecisions dans convex/decisions.ts
  // const savedDecisions = useQuery(
  //   api.decisions.getSavedDecisions,
        ...
        <div className="hidden lg:sticky lg:top-0 z-20 border-b border-border/50 bg-background/95 backdrop-blur-xl">
          <div className="max-w-[614px] mx-auto px-4 py-4">
            <div className="flex items-center gap-3">
              <SolarIcon icon="bookmark-bold" className="size-6 text-primary" />
