...
import { FollowersTab } from "@/components/organization/FollowersTab";
      ...
      <div className="space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-0">
          <OrganizationHeader 
            ...
            onEdit={organization.canEdit ? () => router.push(`/studio/organizations/${organizationId}`) : undefined}
            activeTab={activeTab}
          ...
          <div className="pt-6">
            ...
            <TabsContent value="followers" className="mt-0">
              <FollowersTab organizationId={organizationId} />
            </TabsContent>
          </div>
        </Tabs>
      </div>
