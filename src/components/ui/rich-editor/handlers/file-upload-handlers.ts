  ...
  return async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (onUploadImage) {
        ...
        console.log("✅ Image upload handler retourné:", fileUrl, "type:", typeof fileUrl, "startsWith blob:", fileUrl?.startsWith('blob:'));
      } else {
      ...
      if (!fileUrl || (typeof fileUrl === 'string' && fileUrl.trim() === '')) {
        console.error("❌ Erreur: fileUrl invalide", fileUrl);
      ...
      console.log("✅ Media node créé:", {
        id: mediaNode.id,
        type: mediaNode.type,
        src: mediaNode.attributes.src,
        srcType: typeof mediaNode.attributes.src,
        isBlob: mediaNode.attributes.src?.startsWith('blob:')
      });
