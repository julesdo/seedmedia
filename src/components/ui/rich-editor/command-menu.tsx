...
import { ChartData, ChartSeries, ChartDataPoint } from "@/components/blocks/editor-00/nodes/chart-node"
...
const commands: CommandOption[] = [
  ...
  },
  {
    ...
    keywords: ["chart", "graph", "graphique", "data", "visualization"],
  },
  {
    label: "Table",
    value: "table",
...
export function CommandMenu({
  ...
  const handleSelect = useCallback(
    async (commandValue: string) => {
      ...
      // Special handling for chart - create a default chart node
      if (commandValue === "chart") {
        onClose()
        ...
        // Update the node to be a chart node
        requestAnimationFrame(() => {
          requestAnimationFrame(() => {
            dispatch(
              EditorActions.updateNode(nodeId, {
